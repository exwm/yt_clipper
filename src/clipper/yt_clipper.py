...
def getSpeedFilterAndDuration(
    speedMap: SpeedMap, mp: DictStrAny, mps: DictStrAny, fps: Union[float, Fraction]
...
def getZoomPanFilter(
    cropMap: CropMap, mps: DictStrAny, fps: Union[float, Fraction], easeType: str = "easeInOutSine"
) -> Tuple[str, int]:
