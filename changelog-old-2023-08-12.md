...
- [yt\_clipper Changelog (Post-Version-Unification)](#yt_clipper-changelog-post-version-unification)
  - [v5.12.0 `[2023.03.04]`](#v5120-20230304)
    - [Clipper Changes](#clipper-changes)
  - [v5.11.1 `[2022.11.09]`](#v5111-20221109)
...
- Update `yt_dlp` dependency from  `v2022.10.4` to `v2023.03.03`.
...
- Fix some video players refusinga to play h264 video due to specifying format `h264` instead of `mp4` when encoding with libx264
